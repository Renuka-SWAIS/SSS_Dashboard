...
CREATE TABLE IF NOT EXISTS sss_student_learning_profiles (
    ...
    CONSTRAINT sss_student_learning_profiles_student_chapter_unique UNIQUE (student_id, chapter_id)
);

CREATE INDEX IF NOT EXISTS idx_sss_student_learning_profiles_student_id
    ON sss_student_learning_profiles (student_id);

CREATE INDEX IF NOT EXISTS idx_sss_student_learning_profiles_chapter_id
    ON sss_student_learning_profiles (chapter_id);
